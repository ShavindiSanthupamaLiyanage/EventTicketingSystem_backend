...
////import com.shavi.realtimeeventticketingsystemcli.configurations.LoggerConfiguration;
////import com.shavi.realtimeeventticketingsystemcli.configurations.SystemConfiguration;
////import com.shavi.realtimeeventticketingsystemcli.BackendService;
////import com.shavi.realtimeeventticketingsystemcli.TicketHandlingService;
////import com.shavi.realtimeeventticketingsystemcli.InputHandler;
////
////public class Main extends LoggerConfiguration {
////
////    public static void main(String[] args) {
...
////        System.out.println("Welcome to the Ticketing System CLI");
////
////        int totalTickets = inputHandler.getValidInput("Enter total tickets (0 or positive):", 1, Integer.MAX_VALUE);
////        int ticketReleaseRate = inputHandler.getValidInput("Enter ticket release rate (0 to 100):", 1, 100);
////        int customerRetrievalRate = inputHandler.getValidInput("Enter customer retrieval rate (1 to 10):", 1, 10);
////        int maxTicketCapacity = inputHandler.getValidInput("Enter maximum ticket capacity (0 or positive):", 1, Integer.MAX_VALUE);
////
////        SystemConfiguration config = new SystemConfiguration(totalTickets, maxTicketCapacity, customerRetrievalRate, ticketReleaseRate);
////        backendService.sendConfigToBackend(config);
////
////        TicketPool ticketPool = new TicketPool(maxTicketCapacity);
////        TicketHandlingService ticketHandlingService = new TicketHandlingService(ticketPool, ticketReleaseRate);
////
////        while (true) {
////            System.out.println("Enter '1' to START, '2' to PAUSE, or '0' to EXIT:");
////            String command = inputHandler.getCommand();
////
////            switch (command) {
////                case "1":
////                    ticketHandlingService.startTicketingOperations();
////                    break;
////                case "2":
////                    ticketHandlingService.stopTicketingOperations();
////                    break;
////                case "0":
////                    ticketHandlingService.stopTicketingOperations();
////                    System.out.println("Exiting the system. Goodbye!");
